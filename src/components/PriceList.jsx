...
const pricingSections = [
  {
    ...
    features: [
      { name: "Custom Design", basic: "check", standard: "check", premium: "check" },
      { name: "Cover + Countdown", basic: "check", standard: "check", premium: "check" },
      { name: "Couple Profile", basic: "check", standard: "check", premium: "check" },
      { name: "Gallery", basic: "10 Photos", standard: "20 Photos", premium: "Unlimited" },
      { name: "Google Maps", basic: "check", standard: "check", premium: "check" },
      ...
      { name: "Animation/Parallax", basic: "-", standard: "-", premium: "check" },
    ]
  },
  {
    category: "Interactive Feature",
    features: [
      { name: "RSVP Online", basic: "check", standard: "check", premium: "check" },
      { name: "Wishes & Prayers", basic: "check", standard: "check", premium: "Unlimited" },
      { name: "Digital Gift", basic: "check", standard: "check", premium: "Multi Account" },
      { name: "Realtime Dashboard", basic: "-", standard: "check", premium: "check" },
  ...
  },
  {
    ...
    features: [
        {name: "Responsive Design", basic: "check", standard: "check", premium: "check"},
        {name: "Revision", basic: "2x", standard: "2x", premium: "Unlimited"},
        {name: "Process Time", basic: "2-3 Days", standard: "2-3 Days", premium: "1-2 Days"},
      ...
      <motion.div>
        ...
        <div className="w-full grid grid-cols-4 gap-6 items-end mb-8 px-4">
          ...
          <div className="bg-white border-2 border-gray-100 rounded-2xl p-6 shadow-sm text-center">
            ...
            <p className="text-xs text-[#002366] text-left mt-1">one time purchase - forever active</p>
          ...
          <div className="bg-[#002366] text-white rounded-2xl p-6 shadow-md text-center transform scale-105">
            ...
            <p className="text-xs text-blue-200 text-left mt-1">one time purchase - forever active</p>
            ...
            <tbody>
              {pricingSections.map((section, sIdx) => (
                <React.Fragment key={sIdx}>
                  ...
                  <tr>
                    <td colSpan={4} className="pt-10 pb-4 font-price  text-xl font-bold border-b border-gray-200">
                      {section.category}
                    </td>
                  </tr>
                  ...
                  {section.features.map((feature, fIdx) => (
                    <tr key={fIdx} className="border-b border-gray-200 hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="py-4 text-center"><RenderCell value={feature.basic} /></td>
                      <td className="py-4 text-center bg-blue-50/20"><RenderCell value={feature.standard} /></td>
                      <td className="py-4 text-center"><RenderCell value={feature.premium} /></td>
                    </tr>
                  ))}
                </React.Fragment>
              ))}
